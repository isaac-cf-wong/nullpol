...
from ..psd import (simulate_psd_from_bilby_psd,
                   simulate_stft_psd_from_bilby_psd)
...
def simulate_stft_psd(interferometer, frequency_resolution, window_function, nsample):
    stft_psd = simulate_stft_psd_from_bilby_psd(psd=interferometer.power_spectral_density,
                                                seglen=interferometer.duration,
                                                srate=interferometer.sampling_frequency,
...
def simulate_calibrated_stft_psd(interferometer, calibration_errors, frequency_resolution, window_function, nsample):
    calibrated_psd = get_calibrated_power_spectral_density(frequency_array=interferometer.frequency_array,
                                                           power_spectral_density_array=interferometer.power_spectral_density_array,
                                                           calibration_errors=calibration_errors)
    stft_psd = simulate_stft_psd_from_bilby_psd(psd=calibrated_psd,
                                                seglen=interferometer.duration,
                                                srate=interferometer.sampling_frequency,
                                                frequency_resolution=frequency_resolution,
                                                window_function=window_function,
...
def compute_wavelet_domain_strain_array(interferometer,
...
def compute_time_frequency_domain_strain_array(interferometer,
                                               ...
                                               window_function):
    return stft(data=interferometer.time_domain_strain,
                sampling_frequency=interferometer.sampling_frequency,
                frequency_resolution=frequency_resolution,
                window_function=window_function)


def compute_geocentric_time_shifted_wavelet_domain_strain_array(interferometer,
                                                                       ra,
                                                                       dec,
                                                                       gps_time,
                                                                       wavelet_frequency_resolution,
...
def compute_geocentric_time_shifted_time_frequency_domain_domain_strain_array(interferometer,
                                                                              ra,
                                                                              dec,
                                                                              gps_time,
                                                                              frequency_resolution,
    ...
    time_shifted_time_domain_strain_array = infft(frequency_domain_strain=time_shifted_frequency_domain_strain_array,
                                                  sampling_frequency=interferometer.sampling_frequency)
    return stft(data=time_shifted_time_domain_strain_array,
                sampling_frequency=interferometer.sampling_frequency,
                frequency_resolution=frequency_resolution,
                window_function=window_function)
...
def get_simulated_calibrated_stft_psd(interferometer,
                                      parameters,
                                      frequency_resolution,
                                      window_function,
                                      nsample,
    ...
    calibrated_psd = PowerSpectralDensity(frequency_array=interferometer.frequency_array.copy(),
                                           psd_array=calibrated_psd_array)
    wavelet_psd = simulate_stft_psd_from_bilby_psd(psd=calibrated_psd,
                                                   seglen=interferometer.duration,
                                                   srate=interferometer.sampling_frequency,
                                                   frequency_resolution=frequency_resolution,
                                                   window_function=window_function,
