...
def transform_wavelet_freq_quadrature(data, sampling_frequency, frequency_resolution, nx=4.0):
    ...
    return _transform_wavelet_freq_quadrature_helper(data, Nf, Nt, phif) * np.sqrt(time_domain_length)
...
def transform_wavelet_freq(data, sampling_frequency, frequency_resolution, nx=4.0):
    ...
    return _transform_wavelet_freq_helper(data, Nf, Nt, phif) * np.sqrt(time_domain_length)
