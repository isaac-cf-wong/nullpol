...
def compute_filter_by_quantile(time_freq_transformed: np.ndarray, quantile: float = 0.9):
    ...
    """
    # threshold the data
    tf_filter = time_freq_transformed > np.quantile(time_freq_transformed[time_freq_transformed > 0.0], quantile)
