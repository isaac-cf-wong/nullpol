...
@pytest.fixture
def basic_injection_parameters():
    """Provide standard binary black hole parameters for injection tests.
...
@pytest.fixture
def interferometers():
    """Provide standard 3-detector network for testing.

    Returns:
        InterferometerList: H1, L1, V1 detector network
    """
