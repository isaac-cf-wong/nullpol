...
class TestPlotSpectrogram:
    ...
    @patch('nullpol.analysis.clustering.plotting.Spectrogram')
    @patch('nullpol.analysis.clustering.plotting.plt')
    def test_spectrogram_with_frequency_range(self, mock_plt, mock_spectrogram_class, mock_get_shape, simple_spectrogram_data):
    ...
    @patch('nullpol.analysis.clustering.plotting.Spectrogram')
    @patch('nullpol.analysis.clustering.plotting.plt')
    def test_spectrogram_without_frequency_range(self, mock_plt, mock_spectrogram_class, mock_get_shape, simple_spectrogram_data):
    ...
    @patch('nullpol.analysis.clustering.plotting.Spectrogram')
    @patch('nullpol.analysis.clustering.plotting.plt')
    def test_spectrogram_default_parameters(self, mock_plt, mock_spectrogram_class, mock_get_shape, simple_spectrogram_data):
        ...
        mock_spectrogram_class.assert_called_once_with(
            simple_spectrogram_data,
            t0=0,  # Default t0
            dt=4.0 / 6,  # duration / Nt
            df=8.0,
            name=None  # Default title
        )
