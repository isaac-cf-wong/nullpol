...
class TestAntennaPatternConditioning:
    ...
    def test_compute_whitened_antenna_pattern_matrix_simple_case(self):
        ...
        result = compute_whitened_antenna_pattern_matrix_masked(antenna_pattern_matrix, psd_array, frequency_mask)
    ...
    def test_compute_calibrated_whitened_antenna_pattern_matrix_complex_calibration(self):
        ...
        expected = np.array([[[1.0 * (1.0 + 1.0j), 0.5 * (1.0 + 1.0j)]]], dtype=np.complex128)
    ...
    def test_conditioning_functions_consistency(self):
        ...
        # Step 1: Whiten
        whitened = compute_whitened_antenna_pattern_matrix_masked(antenna_pattern_matrix, psd_array, frequency_mask)
